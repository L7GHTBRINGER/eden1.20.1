...
public class WarpedhagEntity extends Monster implements GeoEntity {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public WarpedhagEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, CrimsonhagEntity.class, true));

    }

    public WarpedhagEntity getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return ModEntities.WARPEDHAG.get().create(level);
    }
