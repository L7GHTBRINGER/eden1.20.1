...
public class ShroomhagEntity extends Monster implements GeoEntity {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public ShroomhagEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public ShroomhagEntity getBreedOffspring(ServerLevel level, AgeableMob ageableMob) {
        return ModEntities.SHROOMHAG.get().create(level);
    }
